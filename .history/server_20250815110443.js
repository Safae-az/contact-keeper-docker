...
// Configuration MongoDB pour Docker Compose
// Utilise 'mongodb' (nom du service) au lieu de 'localhost' dans Docker
const DEFAULT_MONGO_URI = process.env.NODE_ENV === 'production' || process.env.DOCKER_ENV 
  ? 'mongodb://mongodb:27017/contactkeeper'  // Dans Docker
  : 'mongodb://localhost:27017/contactkeeper'; // En local
